...
import {
  DeckProgress,
  CardTypeProgressStats,
  StrugglingWord,
} from '../types';
import './SharedDeckProgressPage.css'; // Reuse the same styles
...
function CardTypeProgressBar({ label, stats }: CardTypeProgressBarProps) {
...
function StrugglingWordItem({ word }: StrugglingWordItemProps) {
  return (
...
export function DeckProgressPage() {
  ...
  const { completion, card_type_breakdown, struggling_words, activity } = progress;
      ...
      <div className="container">
        ...
        <div className="sdp-section">
          ...
          <div className="card-type-breakdown">
            ...
            <CardTypeProgressBar
              label="Hanzi → Meaning"
              stats={card_type_breakdown.hanzi_to_meaning}
            />
            <CardTypeProgressBar
              label="Meaning → Hanzi"
              stats={card_type_breakdown.meaning_to_hanzi}
            />
            <CardTypeProgressBar
              label="Audio → Hanzi"
              stats={card_type_breakdown.audio_to_hanzi}
            />
          </div>
        </div>
